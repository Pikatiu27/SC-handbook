...
- For `Custom / Built-up` inputs, show the custom property card first and hide standard lookup or factor cards that have no concrete value for the selected custom case.
