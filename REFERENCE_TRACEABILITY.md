...
| Screw Piles Selector | Optional action-effect screen formula language | `AS2159_2009.pdf`; `Fifteen years of geotechnical limit state design in Australia.pdf`; `Pile design and construction practice.pdf`; `Craig's Soil Mechanics.pdf`; `Katana_Screw_Lateral_Capacity_Graphs_2025.pdf` | Local packs support treating pile design as comparison of design action effects with geotechnical/structural resistance, and identify pile groups under combined axial/lateral/moment loading, group settlement, pile-head lateral displacement, head fixity and testing as governing checks | Static action-effect distribution only: rigid cap, identical pile stiffness and user-entered values; no AS 2159 compliance check, geotechnical resistance calculation or settlement calculation |
