...
assert.match(panel, /Separate design thickness, t<sub>d<\/sub>/);
assert.match(panel, /Project-specified deduction\./);
...
assert.match(monopoleApp, /Minimum design moment capacity/);
assert.match(monopoleApp, /Minimum permitted bending moment/);
