...
assert.match(panel, /<span class="input-group-heading"><b>Geometry<\/b><\/span>/);
...
assert.doesNotMatch(panel, /id="monopoleMaterialHeading"[^>]*>[\s\S]{0,160}<small>/);
...
assert.match(html, /src="monopole-capacity\.js\?v=20260821monopolesegments1"/);
assert.match(html, /src="monopole-app\.js\?v=20260821monopolesegments1"/);
assert.match(html, /href="styles\.css\?v=20260821monopolestage1"/);
assert.match(html, /SC Handbook &middot; Public beta &middot; Build 0\.7\.70/);
