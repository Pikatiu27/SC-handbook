...
assert.match(panel, /Basis and AS 4100 category apply to all segments\./);
...
assert.match(html, /href="styles\.css\?v=20260821weldmonopoleflow1"/);
assert.match(html, /SC Handbook &middot; Public beta &middot; Build 0\.7\.72/);
