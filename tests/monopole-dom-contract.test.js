...
assert.match(html, /src="monopole-app\.js\?v=20260820monopolelayout1"/);
assert.match(html, /href="styles\.css\?v=20260821memberfigurelayout1"/);
assert.match(html, /SC Handbook &middot; Public beta &middot; Build 0\.7\.65/);
