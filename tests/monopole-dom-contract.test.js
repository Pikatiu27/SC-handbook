...
assert.match(panel, /AS 4100 Cls 5\.2, 6\.2 and 8\.3\.2/);
...
assert.match(monopoleApp, /Moment profile not checked/);
...
assert.match(html, /src="monopole-capacity\.js\?v=20260807monopolerelease2"/);
assert.match(html, /src="monopole-app\.js\?v=20260807monopolerelease2"/);
assert.match(html, /href="styles\.css\?v=20260807monopolerelease2"/);
assert.match(html, /SC Handbook &middot; Build 0\.7\.30/);
