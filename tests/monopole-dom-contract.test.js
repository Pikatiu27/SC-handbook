...
assert.match(styles, /\.monopole-design-thickness-toggle\s*\{[^}]*grid-column:\s*1\s*\/\s*-1;[^}]*width:\s*min\(100%,\s*480px\);/);
assert.match(styles, /@media \(min-width:\s*761px\) and \(max-width:\s*900px\)\s*\{[\s\S]*?\.monopole-design-thickness-toggle\s*\{[^}]*grid-column:\s*auto;[^}]*width:\s*100%;/);
