...
assert.match(panel, /Default t<sub>d<\/sub> = t<sub>nom<\/sub>; enable for a project design thickness\./);
assert.match(panel, /Yield-strength basis/);
assert.match(panel, /AS 4100 fabrication category/);
assert.match(panel, /Circular section only; sets Table 5\.2 compactness limits\./);
