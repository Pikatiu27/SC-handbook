...
assert.match(html, /class="svg-groove-mark svg-square-mark" d="M111 50 L111 76"/);
assert.equal((weldPanel.match(/class="weld-figure-ref"/g) || []).length, 12);
assert.match(weldPanel, /Fig\. 5\.8/);
assert.match(weldPanel, /Fig\. 5\.9/);
assert.match(weldPanel, /Fig\. 5\.10/);
assert.match(weldPanel, /App\. B Fig\. B\.2/);
assert.match(weldPanel, /App\. B Fig\. B\.5/);
assert.match(weldPanel, /App\. B Fig\. B\.3/);
assert.match(weldPanel, /Fig\. 7\.6\(d\)/);
assert.match(weldPanel, /Figs\. 7\.24 and 7\.27\(a\)/);
assert.match(weldPanel, /Standards figures are not reproduced/);
