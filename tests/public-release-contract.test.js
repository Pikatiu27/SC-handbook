...
assert.match(html, /Build 0\.7\.55/, "The visible public build must match this release");
...
assert.match(html, /app\.js\?v=20260819plyarea1/, "The current shared bolt display path must be cache-busted");
