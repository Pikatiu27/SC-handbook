...
assert.match(html, /Build 0\.7\.73/, "The visible public build must match this release");
...
assert.match(html, /monopole-app\.js\?v=20260821monopoleflow1/, "The corrected Monopole display module must be cache-busted");
...
assert.match(html, /app\.js\?v=20260821axialrelease1/, "The current shared display path must be cache-busted");
