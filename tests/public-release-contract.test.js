...
assert.match(html, /styles\.css\?v=20260820boltflow5/, "The current shared layout stylesheet must be cache-busted");
...
assert.match(html, /app\.js\?v=20260820boltflow5/, "The current shared display path must be cache-busted");
