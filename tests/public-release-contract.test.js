...
assert.match(html, /Build 0\.7\.71/, "The visible public build must match this release");
assert.match(html, /styles\.css\?v=20260821monopoleflow1/, "The current shared layout stylesheet must be cache-busted");
