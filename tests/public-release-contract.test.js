...
assert.match(html, /styles\.css\?v=20260821memberfigurelayout1/, "The current shared layout stylesheet must be cache-busted");
...
assert.match(html, /member-form-factor\.js\?v=20260821memberkf1/, "The member form-factor path must be cache-busted");
assert.match(html, /app\.js\?v=20260821memberkf1/, "The current shared display path must be cache-busted");
