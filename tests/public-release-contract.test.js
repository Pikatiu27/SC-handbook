...
assert.match(html, /styles\.css\?v=20260821reomerge1/, "The merged shared layout stylesheet must be cache-busted");
...
assert.match(html, /app\.js\?v=20260821reomerge1/, "The merged shared display path must be cache-busted");
