...
assert.match(html, /Build 0\.7\.69/, "The visible public build must match this release");
assert.match(html, /styles\.css\?v=20260821axialrelease1/, "The current shared layout stylesheet must be cache-busted");
