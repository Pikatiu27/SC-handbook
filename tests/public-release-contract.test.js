...
assert.match(html, /styles\.css\?v=20260821reoheading1/, "The current Reinforcement layout stylesheet must be cache-busted");
...
assert.match(html, /app\.js\?v=20260820reolanguage1/, "The current shared display path must be cache-busted");
