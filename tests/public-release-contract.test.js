...
assert.match(html, /Build 0\.7\.63/, "The visible public build must match this release");
assert.match(html, /styles\.css\?v=20260821plainheadings1/, "The current shared layout stylesheet must be cache-busted");
...
assert.match(html, /app\.js\?v=20260821plainheadings1/, "The current shared display path must be cache-busted");
...
assert.ok(html.indexOf("Block shear · governing path") < html.indexOf("Connection capacity summary"));
