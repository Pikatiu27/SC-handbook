...
assert.match(html, /Build 0\.7\.70/, "The visible public build must match this release");
assert.match(html, /styles\.css\?v=20260821monopolestage1/, "The current shared layout stylesheet must be cache-busted");
