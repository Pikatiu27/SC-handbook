...
assert.match(html, /Build 0\.7\.59/, "The visible public build must match this release");
assert.match(html, /styles\.css\?v=20260820monopolelayout1/, "The current shared layout stylesheet must be cache-busted");
...
assert.match(html, /app\.js\?v=20260820padrelease1/, "The current shared display path must be cache-busted");
