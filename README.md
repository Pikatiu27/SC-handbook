...
The weld symbol legend uses compact public-guidance-style examples for arrow-side, other-side, both-side fillet welds and CPBW notation. Use AS 1101.3 for formal welding-symbol placement and ASI *Simple Connections* 2020 Figure 2.7 for common AS 4100 weld-type terminology. Confirm exact weld symbols, preparations, weld category, WPS, inspection and acceptance criteria to AS/NZS 1554.1 on the project drawings.
